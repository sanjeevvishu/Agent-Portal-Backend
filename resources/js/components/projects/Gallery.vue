<template>
  <section>
    <div class="row mt-2">
      <div class="col-md-6"><strong>Gallery List</strong></div>
      <div class="col-md-6 text-end">
        <button
          @click="openGaleryNViewsModal('Gallery')"
...
export default {
  ...
  components: {
    GalleryUpload: () =>
      import(
        /* webpackChunkName: "GalleryUpload" */ "./GalleryUpload.vue"
      ),
    GalleryCarousel: () =>
      import(
        /* webpackChunkName: "GalleryCarousel" */ "./GalleryCarousel.vue"
      )
  },
  data() {
    return {
  ...
  methods: {
    ...
    getItems() {
      ...
      this.axios.get(mediatGalleryListUrl,{params:{asset_type: 'gallery'}}).then(response => {
        setTimeout(() => {
