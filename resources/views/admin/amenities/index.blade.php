...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Amenities') }} <a class="btn btn-sm btn-secondary"
                        href="{{ route('admin.amenities.create') }}">Add New</a>
                </div>
                        ...
                        <tbody>
                            @forelse($amenities as $row)
                                <tr>
                                    ...
                                    <td>
                                        @if($row->s3_icon_path)
                                        <img src="{{ asset($row->media_s3_base_path.$row->s3_icon_path) }}" width="100" class="img-fluid" /> 
                                        @else
                                        -
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.amenities.edit',$row->id) }}" title="Edit">Edit</a>

                                        | <form method="post" class="delete_form"
                                            action="{{ route('admin.amenities.destroy',$row->id) }}"
