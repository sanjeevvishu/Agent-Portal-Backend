...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('CuEvents') }} <a class="btn btn-sm btn-secondary"
                        href="{{ route('admin.cuEvents.create') }}">Add New</a>
                </div>
                            ...
                            @forelse($cuEvents as $row)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.cuEvents.edit',$row->id) }}" title="Edit">Edit</a>

                                        | <form method="post" class="delete_form"
                                            action="{{ route('admin.cuEvents.destroy',$row->id) }}"
