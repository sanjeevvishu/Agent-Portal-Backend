<div class="row">
    <div class="col-md-12">
        ...
        <div class="mb-3">
            {!! Form::label('youtube_url', 'Youtube URL', ['class' => 'form-label']) !!} <span
...
@if(!empty($cuEvent))
    <div class="row">
        ...
        <div class="col-md-3">
            @if($cuEvent->featured_image)
                <div class="mb-3">
                    {!! Form::label('featured_image2', 'Preview', ['class' => 'form-label']) !!}
                    <div>
                        <img src="{{ asset($cuEvent->media_s3_base_path.$cuEvent->featured_image) }}" width="100"
                            class="img-fluid" />
                    </div>
                </div>
            @endif
